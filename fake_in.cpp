    ...
    : interfacing(parent)
{
    ...
    createSlider(&ISU_CONNECT.planePosX, -15000, 15000, 2000);
    createLabelValue(&ISU_CONNECT.planePosY, "Plane_Position's_Y");
    createSlider(&ISU_CONNECT.planePosY, -15000, 15000, 2000);
    createLabelValue(&ISU_CONNECT.planePosZ, "Plane_Position's_Z");
    createSlider(&ISU_CONNECT.planePosZ, 0.0, 3000, 2000);
